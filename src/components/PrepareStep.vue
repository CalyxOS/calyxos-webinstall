<template>
    <v-container class="d-flex justify-space-between flex-column flex-grow-1">
        <div class="mb-10 mt-n4" v-if="usbSupported">
            ...
            <p class="text-body-1 mt-2"><strong>Settings</strong> → <strong>About Phone</strong> → tap <strong>Build number</strong> 7 times</p>

            <h6 class="text-h6 mt-4">Enable USB debugging</h6>

            <p class="text-body-1 mt-2"><strong>Settings</strong> → <strong>System</strong> → <strong>Advanced</strong> → <strong>Developer Options</strong> → <strong>USB Debugging</strong></p>

            <h6 class="text-h6 mt-4">Enable OEM Unlocking</h6>

            <p class="text-body-1 mt-2"><strong>Settings</strong> → <strong>System</strong> → <strong>Advanced</strong> → <strong>Developer Options</strong> → <strong>OEM unlocking</strong></p>
